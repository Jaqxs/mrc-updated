...
export default function JobManagementPage() {
  ...
  const fetchJobs = async () => {
    try {
      const res = await authorizedFetch("http://127.0.0.1:8000/api/jobs/admin/all/")
  ...
  const fetchCategories = async () => {
    try {
      const res = await fetch("http://127.0.0.1:8000/api/jobs/categories/")
  ...
  const fetchUsers = async () => {
    try {
      const res = await authorizedFetch("http://127.0.0.1:8000/api/users/")
  ...
  const fetchProfile = async () => {
    try {
      const res = await authorizedFetch("http://127.0.0.1:8000/api/accounts/profile/")
  ...
  const fetchApplications = async () => {
    try {
      const res = await authorizedFetch("http://127.0.0.1:8000/api/jobs/applications/all/")
  ...
  const updateApplicationStatus = async (applicationId: number, status: string) => {
    setLoading(true)
    try {
      const res = await authorizedFetch(`http://127.0.0.1:8000/api/jobs/applications/update/${applicationId}/`, {
        method: "PATCH",
  ...
  const confirmDelete = async () => {
    ...
    try {
      const res = await authorizedFetch(`http://127.0.0.1:8000/api/jobs/update/${jobToDelete}/`, {
        method: "DELETE",
      })
  ...
  const toggleJobStatus = async (jobId: number, currentStatus: boolean) => {
    setLoading(true)
    try {
      const res = await authorizedFetch(`http://127.0.0.1:8000/api/jobs/update/${jobId}/`, {
        method: "PATCH",
  ...
  const updateJob = async () => {
    ...
    setLoading(true)
    try {
      const res = await authorizedFetch(`http://127.0.0.1:8000/api/jobs/update/${editingJob.id}/`, {
        method: "PATCH",
  ...
  const toggleUserStatus = async (userId: number, currentStatus: boolean) => {
    setLoading(true)
    try {
      const res = await authorizedFetch(`http://127.0.0.1:8000/api/accounts/users/${userId}/`, {
        method: "PATCH",
        body: JSON.stringify({ is_active: !currentStatus }),
      })
  ...
  const handleAddJob = async () => {
    ...
    try {
      ...
      const res = await authorizedFetch("http://127.0.0.1:8000/api/jobs/create/", {
        method: "POST",
